...
public class BookingInfoGUI extends JFrame {
    ...
    private void searchButtonClicked() {
        Thread thread = new Thread(() -> {
            ...
            if (isDate(startDateString) && isDate(endDateString)) {
                ...
                campsites = bookingController.getAvailableCampsites(startDateString, endDateString, searchForCabin,
                        searchForPitch);
    ...
    private void confirmButtonClicked() {
        ...
        if (necessaryInformationValid()) {
            ...
            bookingController.addCampsiteToBooking(currentCampsite, startDateString, endDateString, includeFee);

            int amountOfAdults =  (int) amountOfAdultsComboBox.getSelectedItem();
            int amountOfChrildren = (int) amountOfChildrenComboBox.getSelectedItem();
            ...
            JOptionPane.showMessageDialog(null, "Please fill out all the textFields and select a campsite",
    ...
    private void updateCustomerInfoButtonClicked() {
        JOptionPane.showMessageDialog(null, "This feature is not yet implemented.", "Not Implemented",
        ...
        Thread thread = new Thread(() -> {
            ...
            if (customer != null) {
                ...
                if (informationInAnyTextFields() && !informationInFieldsMatchesCustomer(customer)) {
                    customerInfoWarningDisplayed = true;
                    int result = JOptionPane.showConfirmDialog(null,
                            "Customer found, do you want to override existing textfields?", "Warning",
    ...
    private void fillAmountOfPeopleComboBox() {
        for (int i = 1; i <= 10; i++) {
            amountOfAdultsComboBox.addItem(i);
            amountOfChildrenComboBox.addItem(i);
        }
