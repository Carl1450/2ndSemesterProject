...
public class CreateEmployeeGUI extends JFrame {
    ...
    private void createButtonClicked() {
        ...
        if (allFieldsFilledOut() && isValidName() && isValidAddress()) {
            ...
            displayErrorDialog("Invalid name, remember to type first and lastname");
        } else if (!isValidAddress()) {
            displayErrorDialog("Invalid address, remember to type street and street number");
        } else if (email.isEmpty()) {
            displayErrorDialog("Please fill out email");
        } else if (phoneNumber.isEmpty()) {
            displayErrorDialog("Please fill out phone number");
        } else if (zipcode.isEmpty()) {
            displayErrorDialog("Please fill out zipcode");
        } else if (city.isEmpty()) {
            displayErrorDialog("Please fill out city");
        }  else if (cprNo.isEmpty()) {
            displayErrorDialog("Please fill out CPR-number");
        } else if (password.isEmpty()) {
            displayErrorDialog("Please fill out password");
        } else {
            displayErrorDialog("Cannot create customer, invalid information.");
        }
    }

    private void displayErrorDialog(String errorMessange) {
        JOptionPane.showMessageDialog(null, errorMessange, "Error",
