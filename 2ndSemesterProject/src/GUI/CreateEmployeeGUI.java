...
public class CreateEmployeeGUI extends JFrame {
    ...
    private void createButtonClicked() {
        ...
        if (allFieldsFilledOut() && isValidName() && isValidAddress()) {
            ...
            int employeeId = employeeController.saveEmployee(name, phoneNumber, email, address, zipcode, city, role, cprNo, password);
            if (employeeId != -1) {
                JOptionPane.showMessageDialog(
                        null,
                        "Employee Successfully created in the system. Their id is: " + employeeId,
                        "Success",
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Cannot create customer, missing information.",
                    "Error",
    ...
    private boolean allFieldsFilledOut() {
        ...
        if (name.equals("") || phoneNumber.equals("") || email.equals("") || address.equals("") || zipcode.equals("") || city.equals("") || role.equals("") || cprNo.equals("") || password.equals("")) {
            valid = false;
        }
