...
public class CreateCustomerGUI extends JFrame {
    ...
    private void createButtonClicked() {
        ...
        if (!isValidName()) {
            showErrorMessage("Invalid name, remember to type first and lastname");
        } else if (!isValidAddress()) {
            showErrorMessage("Invalid address, remember to type street and street number");
        } else if (email.isEmpty()) {
            showErrorMessage("Please fill out email");
        } else if (phoneNumber.isEmpty()) {
            showErrorMessage("Please fill out phone number");
        } else if (zipcode.isEmpty()) {
            showErrorMessage("Please fill out zipcode");
        } else if (city.isEmpty()) {
            showErrorMessage("Please fill out city");
        } else {
